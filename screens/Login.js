    ...
    return (
        <View style={styles.mainContainer}>
            ...
            <View style={styles.container}>
                ...
                <Text style={styles.subtitulo}> ¡Bienvenido Comprador! Ingresa con tu cuenta </Text>
                ...
                <Text style={ [
                         styles.textBody, { fontSize: 15,
                            textAlign: "center",
                            marginTop: "20%", color: 'blue', textDecorationLine: 'underline' }]} onPress={() => navigation.navigate('Login2')}> Ingresar como vendedor</Text>

                <Text style={{
                    fontSize: 15,
                    textAlign: "center",
                }}>¿No tienes una cuenta?<Text style={[styles.textBody, { color: 'blue', textDecorationLine: 'underline' }]} onPress={() => navigation.navigate('Register')}> Regístrate</Text></Text>
